...
- **The `miint-sequence-split`, `miint-host-filter-fns`, `miint-infer-trim`, and `miint-gpl-boundary` compute-readiness probes now fail under `python -O` / `PYTHONOPTIMIZE`, where they previously reported ok (#592).**
