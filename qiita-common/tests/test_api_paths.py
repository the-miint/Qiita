...
_TRIPLES: list[tuple[str, str, str]] = [
    ...
    ("URL_STEP_CANCEL", "PATH_STEP_PREFIX", "PATH_STEP_CANCEL"),
    # /reference-artifact
    (
    ...
    ("URL_WORK_TICKET_CANCEL", "PATH_WORK_TICKET_PREFIX", "PATH_WORK_TICKET_CANCEL"),
    ("URL_WORK_TICKET_STEP_LOGS", "PATH_WORK_TICKET_PREFIX", "PATH_WORK_TICKET_STEP_LOGS"),
    ("URL_WORK_TICKET_FANOUT", "PATH_WORK_TICKET_PREFIX", "PATH_WORK_TICKET_FANOUT"),
    (
