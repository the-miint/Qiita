...
def test_incomplete_subclass_cannot_be_instantiated():
    """A subclass implementing only part of the contract stays abstract —
    this is what stops a resolver from silently returning `None`/empty for
    a method its author forgot to implement."""
    from qiita_control_plane.ena_import.resolver import EnaResolver
