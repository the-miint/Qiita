...
# sort is what drove the step's YAML baseline to 32 GiB rather than 16. That step's
# `baseline_resources` comment carries the measurement and what it does not settle.
_DUCKDB_MEMORY_GB = 8
_DUCKDB_THREADS = 4
