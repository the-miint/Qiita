...
the unbinned noLCG residue (its exclusion key, its bin_id, and what it does to a
hash-collision group), and empty -> StepNoData.
"""
...
def _rc(seq: str) -> str:
    return seq.translate(str.maketrans("ACGTRYSWKMBDHVN", "TGCAYRSWMKVHDBN"))[::-1].upper()
